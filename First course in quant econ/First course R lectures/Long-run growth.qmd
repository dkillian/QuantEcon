...
The dataset covers `r n_distinct(full_data$country)` countries. Coverage varies widely: the UK series runs from year 1 to 2018, while many countries only appear after 1950.
...
```{r gbr-gdppc, fig.width=9, fig.height=5}
...
```{r comparison-gdppc, fig.width=10, fig.height=6}
...
```{r china-gdppc, fig.width=10, fig.height=6}
...
```{r ukus-gdppc, fig.width=10, fig.height=6}
...
```{r early-gdp, fig.width=9, fig.height=5}
...
```{r tooze-figure, fig.width=10, fig.height=6}
...
```{r modern-gdp, fig.width=9, fig.height=5}
...
```{r regional, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
